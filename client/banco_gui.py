...
class Frame_Banco(tk.Frame):
    ...
    def properties_bank(self):
        ...
        self.label_iban.grid(row=2, column=0, pady=10)
        ...
        self.entry_iban.grid(row=2, column=1, pady=10, sticky='WE', columnspan=3)
        ...
        self.boton_nuevo_bnk.grid(row=3, column=1, pady=10, padx=10)
        ...
        self.boton_guardar_bnk.grid(row=3, column=2, pady=10)
        ...
        self.boton_cancelar_bnk.grid(row=3, column=3, pady=10)
    ...
    def table_bank(self):
        self.tabla = ttk.Treeview(self.pes3, columns=('Nombre', 'CIF', 'Telefono', 'Dirección', 'IBAN'), show='headings')
        self.tabla.grid(row=4, column=0, columnspan=5, padx=(10, 0), sticky='nse')
        ...
        self.tabla.heading('#5', text='IBAN')
